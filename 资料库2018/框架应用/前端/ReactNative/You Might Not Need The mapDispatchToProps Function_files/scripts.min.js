...
var r=require("jquery"),e=require("js-cookie");r(document).ready(function(){try{window._search=(window.location.search||"").replace("?","").split("&").map(function(r){return r.split("=")}).reduce(function(r,e){return r[e[0]]=e[1],r},{});var i=window._search.ck_subscriber_id;if(i)(s=e.getJSON("dcreader"))||(s={sub:!0,sid:i},window.__person=s),e.set("dcreader",s)}catch(r){}var s;(s=e.getJSON("dcreader")||window.__person)&&s.sub&&(r(".not-for-subscribers").hide(),r(".for-subscribers").show())});
